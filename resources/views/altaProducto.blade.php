...
<form action="/" method="POST" enctype="multipart/form-data">
    ...
    <div class="Marca_producto">
        ...
        <label for="Categoria"><h3>Producto :</h3></label> <input class="form-control form-control-lg w-50 mb-3 @error('nombre_producto') is-invalid @enderror" type="text" name="nombre_producto"  value = " {{ old('nombre_producto') }}">
        ...
        @enderror
        <br>
        <label for="Categoria"><h3>Precio :</h3></label><input class="form-control form-control-lg w-25 mb-3 @error('precio_producto') is-invalid @enderror" type="text" name="precio_producto"  value = " {{ old('precio_producto') }}">
        ...
        @enderror
        <br>
        <label for="Categoria"><h3>Codigo del Producto :</h3></label><input class="form-control form-control-lg w-25 mb-3 @error('codigo_producto') is-invalid @enderror" type="text" name="codigo_producto"  value = " {{ old('codigo_producto') }}">
        ...
        @enderror
        <br>
        <label for="Categoria"><h3>Cantidad Ingresante: :</h3></label> <input class="form-control form-control-lg w-25 mb-3 @error('stock') is-invalid @enderror" type="text" name="stock"  value = " {{ old('stock') }}">
        @error('stock')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
