            ...
            <div class="card-body">
                <form action="/" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control form-control-lg w-100 mb-3 @error('nombre_producto') is-invalid @enderror" type="text" name="nombre_producto"  value = " {{ old('nombre_producto') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control form-control-lg w-75 mb-3 @error('precio_producto') is-invalid @enderror" type="text" name="precio_producto"  value = " {{ old('precio_producto') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control form-control-lg w-75 mb-3 @error('codigo_producto') is-invalid @enderror" type="text" name="codigo_producto"  value = " {{ old('codigo_producto') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control form-control-lg w-75 mb-3 @error('stock') is-invalid @enderror" type="text" name="stock"  value = " {{ old('stock') }}">
                            @error('stock')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control w-100 form-control-lg @error('detalle_producto') is-invalid @enderror" type="text" name="detalle_producto"   value = " {{ old('detalle_producto') }}">
