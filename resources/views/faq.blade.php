    ...
    <ul>
        ...
        <li>
           <h5> 4. ¿Qué sucede si compro en dos o más tiendas?</h5>
            ...
            Todas las tiendas donde realices tus compras, generarán un número de pedido único.
            <br>
            Podés activar nuestro servicio exclusivo CONSOLIDATE y ahorrar hasta un 50% en costos de envío, según la compañía seleccionada. Así, podrás recibir todos los pedidos en un solo paquete.
            <br>
            Conocé más sobre CONSOLIDATE acá.
        </li>
        <br>
        <li>
        ...
        <li>
           <h5> 6. ¿Cómo sé que recibieron mi pedido?</h5>
            ...
            Una vez generado tu pedido, recibís un mail de confirmación con el detalle de tu pedido y la tienda cuenta de 24 a 48 hrs. hábiles para contactarle y confirmarle stock.
            <br>
            Revisá en tu bandeja de “no deseados” o “spam” en caso que no veas el mail en tu bandeja de entrada.
        </li>
        <br>
        <li>
            ...
            <br>
            Enviaremos tu pedido a la dirección indicada y por el medio que hayas elegido. También te facilitaremos el número de guía para que puedas realizar el seguimiento.
        </li>
        <br>
        <li>
            ...
            Distrito Moda llega a todo el país a través de Correo Argentino, OCA y Envío Cargo. Para envíos a CABA y GBA, contamos con Chazki.
            <br>
            En caso de preferir algún otro expreso o retirarlo personalmente en el local, podés acordar directamente con la marca.
            <br>
            Consultá acá cómo podés seguir tus pedidos.
        </li>
        <br>
        <li>
